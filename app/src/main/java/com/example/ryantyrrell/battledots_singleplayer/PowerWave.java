...
public class PowerWave {
    ...
    public PowerWave(double dot_location_x, double dot_location_y, double start_location_x, double start_location_y, Canvas canvasParameter, ManageObjects manageObjects)  {
